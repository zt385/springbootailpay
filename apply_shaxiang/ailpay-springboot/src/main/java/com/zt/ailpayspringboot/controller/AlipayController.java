package com.zt.ailpayspringboot.controller;
...
import com.zt.ailpayspringboot.utils.AlipayConfig;
import com.zt.ailpayspringboot.utils.LeeJSONResult;
...
public class AlipayController {
	...
	public Object products(Map<String, Object> map) throws Exception {
		...
		map.put("pList", pList);
		return "template/product/product_list";
	}
	...
	public Object goConfirm(String productId, Map<String, Object> map) throws Exception {

		Product p = productService.getProductById(productId); //根据商品查询

		map.put("p", p);

		return "template/pay/go_confirm";
	}
	...
	public Object createOrde2r(Orders order, Map<String, Object> map) throws Exception {
	 ...
	 *
	 * @Title: AlipayController.java
	 * @Description: 支付宝同步通知页面                   注意一下界面不能再本地运行 必须到服务器上运行  所以最下直接返回了一个成功界面
	 */
	...
	public Object alipayReturnNotice(HttpServletRequest request, HttpServletRequest response) throws Exception {
		...
		//return mv;
		return "template/pay/success";//    本地跳转的界面 因为没有上传服务器
	}
